...
<div class="container">
    <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
        ...
        <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
            ...
            <li><a href="${pageContext.request.contextPath}/user/account/admin/authors"
    ...
    <table class="table mt-4">
        ...
        <c:forEach items="${authors}" var="author">
            <tr>
                ...
                <td class="text-end">
                    <a href="${pageContext.request.contextPath}/user/account/admin/authors/edit?id=${author.id}"
                       class="btn btn-sm btn-outline-success me-2"><fmt:message key="admin.edit"/></a>
                    <a href="${pageContext.request.contextPath}/user/account/admin/authors/delete?id=${author.id}"
