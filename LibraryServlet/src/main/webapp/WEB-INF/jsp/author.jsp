...
<div class="container">
    <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
        ...
        <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
            ...
            <li><a href="${pageContext.request.contextPath}/user/account/admin/authors" class="nav-link px-2 link-primary"><fmt:message
...
<div class="container col-xxl-5 py-3">
    <div>
        <form action="${pageContext.request.contextPath}/user/account/admin/authors/save" method="post" class="needs-validation" novalidate="">
            ...
            <a class="w-half btn btn-outline-primary btn-lg mt-5" href="${pageContext.request.contextPath}/user/account/admin/authors" ><fmt:message key="admin.cancel"/></a>
        </form>
    </div>
</div>
