...
<div class="container col-xxl-5 py-3">
    <div>
        <form action="${pageContext.request.contextPath}/admin/books/save" method="post" class="needs-validation" novalidate="">
            ...
            <div class="row g-3">
                <div class="col-12">
                    <label for="name" class="form-label"><fmt:message key="book.yearPublication"/></label>
            ...
            <a class="w-half btn btn-outline-primary btn-lg mt-5" href="${pageContext.request.contextPath}/user/account/admin/books" ><fmt:message key="admin.cancel"/></a>
        </form>
    </div>
</div>
